...
public class FrontController extends HttpServlet {
    ...
    Mapping mapping_avoir_eurreur = null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url_avant = request.getHeader("Referer");
        ...
        try {
            ...
            if ("GET".equalsIgnoreCase(request.getMethod())) {
                ...
                System.out.println("urlAnoter ho jerena :" + urlAnoter);
            }
            ...
            try {
               ...
               //System.out.println("verbe :" + mappinge.get(urlAnoter).getVerbe() + "==-==" + metho_arriver);

                if(mappinge.get(urlAnoter).getVerbe().equals(metho_arriver)){
                    //System.out.println("verbe mitovy mitovy mitovy mitovy :" + mappinge.get(urlAnoter).getVerbe() + "==-==" + metho_arriver);
                    mapping_avoir_eurreur = mappinge.get(urlAnoter);
                ...
                out.println("ato nu eureeur zao");
                //e.printStackTrace(System.err);
                ...
                String contextPath_avant = request.getContextPath(); // Ex: /YourAppName
                String queryString_avant = request.getQueryString(); // Ex: ville=105
                String[] result_fin_avant =  url_avant.split(contextPath);
                String urlAnoter_avant = result_fin_avant[1].replaceFirst("^/", "");
               
                    CustomHttpRequestWrapper requestModifier = new CustomHttpRequestWrapper(request);
                
                    requestModifier.setMethod("GET");

                    String urlpageeurrer =   Utils.pageeurreur(mapping_avoir_eurreur.getClasse_name() , mapping_avoir_eurreur.getMethodName());
                    // Effectuer le forward vers l'URL modifiée
                    RequestDispatcher dispatcher_modif = requestModifier.getRequestDispatcher("/web/" + urlpageeurrer);
                    dispatcher_modif.forward(requestModifier, response);
